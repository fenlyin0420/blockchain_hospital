...
const routes = [
  {
    ...
    children: [ //二级路由
      ...
      { path: 'doctorPlan', name: 'DoctorPlan', meta: { name: '医生排班' }, component: () => import('../views/manager/DoctorPlan') },
      ...
      { path: 'DailyCare', name: 'DailyCare', meta: { name: '日常护理' }, component: () => import('../views/manager/Nurse/DailyCare.vue') },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'test', name: 'Test', meta: { name: '测试页面' }, component: () => import('../views/front/Test') },
    ]
  },
