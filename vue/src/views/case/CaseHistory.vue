  ...
  methods: {
    ...
    decrypt() {
      ...
      this.$request.post("keys/decryptFlat", traverse, {
        params: {
          privateKey: ""
        }
      }).then((res) => {
        console.log("res", res);
        if (res.code === "200") {
