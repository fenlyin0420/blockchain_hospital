    ...
    <div>
        ...
        <div class="table">
            <el-table :data="tableData" stripe>
                <el-table-column prop="traverse.treatmentDate" label="就诊日期" width="200" align="center"
                ...
                <el-table-column prop="hospitalName" label="医院名称" v-if="user.role === 'USER'" width="200"
                    align="center"></el-table-column>
                <el-table-column prop="traverse.inHospital" label="住院情况" width="200" align="center"></el-table-column>
