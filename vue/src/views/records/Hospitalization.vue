<template>
    <div>
      ...
      <div class="table">
        <el-table :data="tableData"  stripe>
         ...
         <el-table-column label="操作"  align="center" v-if="user.role === 'DOCTOR'">
           <template v-slot="scope">
             <el-button plain type="danger" size="mini" @click="update(scope.row)" v-if="user.role !=='USER'">开药</el-button>
      ...
      <el-dialog title="开药详细" :visible.sync="formVisible" width="60%" :close-on-click-modal="false" destroy-on-close>
