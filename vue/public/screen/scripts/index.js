...
function init(){
  ...
  mapChart.setOption({
      bmap: {
          center: [103.834, 36.061], // 兰州市中心坐标（经度, 纬度）
          zoom: 13,                  // 初始缩放级别（可调整）
          roam: true
      },
      tooltip: {
      ...
      series: [{
          ...
          data: [
              // 格式：[经度, 纬度, 名称] 
              // 以下坐标需通过百度地图坐标拾取工具确认准确性
              [103.841, 36.056, 'xx大学第一附属医院'],     // 示例坐标，需验证
              [103.852, 36.064, 'xx大学第二附属医院'],     // 示例坐标，需验证
            //   [103.817, 36.060, '甘肃省人民医院'],       // 示例坐标，需验证
            //   [103.895, 36.046, '兰州市第二人民医院']     // 示例坐标，需验证
          ]
      }]
  });
